"""PygoEventLoop -- asyncio.AbstractEventLoop assembled from the loop_* mixins.
...
class PygoEventLoop(_LoopCoreMixin, _LoopScheduleMixin, _LoopIOMixin,
                    _LoopNetMixin, _LoopSubprocessMixin, _LoopSignalMixin,
                    _LoopRunMixin, asyncio.AbstractEventLoop):
    """asyncio.AbstractEventLoop with everything the pygo bridge needs.
