"""_PygoFutureMixin + PygoFuture: synchronous-fire Future replacement."""
from ._base import *  # noqa: F401,F403  (shared foundation)
from .handles import _CANCELLED, _FINISHED, _PENDING, _STOCK_TASK_TYPES, _run_stock_task_cb  # noqa: F401
# PygoTask is imported lazily inside _fire_callbacks (below) to avoid a
# futures<->tasks import cycle: tasks subclasses _PygoFutureMixin from here.
