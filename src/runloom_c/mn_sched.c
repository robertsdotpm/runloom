...
enum {
    ...
    RUNLOOM_WS_EV_TIMER_CLAIM,    /* a hub claims an EXPIRED SLEEPER PARKED->RUNNING
                                   * (hub_main timer-expiry path); loses the CAS in
                                   * any non-PARKED state -- self-loop on QUEUED when
                                   * a waker raced PARKED->QUEUED first              */
    RUNLOOM_WS_EV_COUNT
};
...
static const signed char runloom_ws_table
    ...
    /*                       WAKE                       PULL                RELEASE            SWEEP_CLAIM           SWEEP_RELEASE       TIMER_CLAIM */
    [RUNLOOM_WS_PARKED]        = { RUNLOOM_WS_QUEUED,        RUNLOOM_FSM_INVALID, RUNLOOM_FSM_INVALID, RUNLOOM_WS_SWEEPING,        RUNLOOM_FSM_INVALID, RUNLOOM_WS_RUNNING  },
    [RUNLOOM_WS_QUEUED]        = { RUNLOOM_WS_QUEUED,        RUNLOOM_WS_RUNNING,  RUNLOOM_FSM_INVALID, RUNLOOM_WS_QUEUED,          RUNLOOM_FSM_INVALID, RUNLOOM_WS_QUEUED   },
    [RUNLOOM_WS_RUNNING]       = { RUNLOOM_WS_RUNNING_WOKEN, RUNLOOM_FSM_INVALID, RUNLOOM_WS_PARKED,   RUNLOOM_WS_RUNNING,         RUNLOOM_FSM_INVALID, RUNLOOM_FSM_INVALID },
    [RUNLOOM_WS_RUNNING_WOKEN] = { RUNLOOM_WS_RUNNING_WOKEN, RUNLOOM_FSM_INVALID, RUNLOOM_WS_QUEUED,   RUNLOOM_WS_RUNNING_WOKEN,   RUNLOOM_FSM_INVALID, RUNLOOM_FSM_INVALID },
    [RUNLOOM_WS_SWEEPING]      = { RUNLOOM_WS_SWEEPING_WOKEN, RUNLOOM_FSM_INVALID, RUNLOOM_FSM_INVALID, RUNLOOM_WS_SWEEPING,        RUNLOOM_WS_PARKED,   RUNLOOM_FSM_INVALID },
    [RUNLOOM_WS_SWEEPING_WOKEN]= { RUNLOOM_WS_SWEEPING_WOKEN, RUNLOOM_FSM_INVALID, RUNLOOM_FSM_INVALID, RUNLOOM_WS_SWEEPING_WOKEN,  RUNLOOM_WS_QUEUED,   RUNLOOM_FSM_INVALID },
};
