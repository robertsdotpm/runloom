/* pygo_iframe.c -- the ONLY translation unit that reaches into CPython's
...
#if PY_VERSION_HEX >= 0x030D0000 && !defined(PYGO_NO_IFRAME)
#  include "internal/pycore_frame.h"
#  define PYGO_IFRAME_HAVE 1
#endif

int pygo_iframe_walk(void *top, int max, pygo_iframe_cb cb, void *ctx)
{
#if defined(PYGO_IFRAME_HAVE)
