# -*- coding: utf-8 -*-
"""Developer tooling and infrastructure -- a developer tooling and infrastructure toy using the disk_files primitive with a compressed payload, expecting success.
