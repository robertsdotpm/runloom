# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the signals primitive with a bytes payload, expecting failure.
...
signals primitive to carry a bytes payload.  Prints PASS and exits 0 when
