# -*- coding: utf-8 -*-
"""Real-time communication and websockets -- a real-time communication and websockets toy using the multiprocessing primitive with a json payload, expecting success.
