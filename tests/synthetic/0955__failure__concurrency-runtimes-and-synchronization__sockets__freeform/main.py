# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the sockets primitive with a freeform payload, expecting failure.
...
sockets primitive to carry a freeform payload.  Prints PASS and exits 0 when
