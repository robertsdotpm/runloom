# -*- coding: utf-8 -*-
"""Task scheduling and background jobs -- a task scheduling and background jobs toy using the multiprocessing primitive with a bytes payload, expecting failure.
