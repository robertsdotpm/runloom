# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the ssl primitive with a unicode payload, expecting failure.
...
ssl primitive to carry a unicode payload.  Prints PASS and exits 0 when
