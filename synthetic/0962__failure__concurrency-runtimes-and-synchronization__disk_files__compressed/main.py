# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the disk_files primitive with a compressed payload, expecting failure.
...
disk_files primitive to carry a compressed payload.  Prints PASS and exits 0 when
