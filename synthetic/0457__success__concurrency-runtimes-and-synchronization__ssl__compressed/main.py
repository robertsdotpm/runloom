# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the ssl primitive with a compressed payload, expecting success.
...
ssl primitive to carry a compressed payload.  Prints PASS and exits 0 when
