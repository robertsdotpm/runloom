# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the select_selectors primitive with a bytes payload, expecting success.
...
select_selectors primitive to carry a bytes payload.  Prints PASS and exits 0 when
