# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the sockets primitive with a bytes payload, expecting failure.
...
sockets primitive to carry a bytes payload.  Prints PASS and exits 0 when
