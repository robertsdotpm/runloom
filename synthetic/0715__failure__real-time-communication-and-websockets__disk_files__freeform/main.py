# -*- coding: utf-8 -*-
"""Real-time communication and websockets -- a real-time communication and websockets toy using the disk_files primitive with a freeform payload, expecting failure.
