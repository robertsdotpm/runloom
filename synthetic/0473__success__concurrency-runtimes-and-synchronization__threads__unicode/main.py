# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the threads primitive with a unicode payload, expecting success.
...
threads primitive to carry a unicode payload.  Prints PASS and exits 0 when
