# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the select_selectors primitive with a json payload, expecting failure.
...
select_selectors primitive to carry a json payload.  Prints PASS and exits 0 when
