# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the select_selectors primitive with a freeform payload, expecting failure.
