# -*- coding: utf-8 -*-
"""Concurrency runtimes and synchronization -- a concurrency runtimes and synchronization toy using the multiprocessing primitive with a compressed payload, expecting success.
...
multiprocessing primitive to carry a compressed payload.  Prints PASS and exits 0 when
