# -*- coding: utf-8 -*-
"""Developer tooling and infrastructure -- a developer tooling and infrastructure toy using the multiprocessing primitive with a bytes payload, expecting success.
