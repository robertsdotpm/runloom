...
def capture(repo=None):
    ...
    info = {
        ...
        "python_ft_3_13t": _py_version(os.path.expanduser("~/.pyenv/versions/3.14.4t/bin/python3")),
        "python_gil_3_13": _py_version(os.path.expanduser("~/.pyenv/versions/3.13.13/bin/python3")),
        "go_version": _run(["go", "version"]),
        "cython_version": _run([os.path.expanduser("~/.pyenv/versions/3.14.4t/bin/python3"),
        ...
        "greenlet": _run([os.path.expanduser("~/.pyenv/versions/3.14.4t/bin/python3"),
